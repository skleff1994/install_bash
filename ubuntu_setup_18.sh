...
sudo sudo -H pip3 install --upgrade pip
sudo sudo -H pip3 install pyopenssl
sudo sudo -H pip3 install --upgrade \
    colorama \
    matplotlib \
    seaborn \
...
sudo sudo -H pip3 install pydot==1.0.28
sudo sudo -H pip3 install pyparsing==2.0.1
sudo sudo -H pip3 install --upgrade six --target="/usr/lib/python2.7/dist-packages"
sudo sudo -H pip3 install appdirs
sudo sudo -H pip3 install --upgrade protobuf
