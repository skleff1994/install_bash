...
sudo apt-get install robotpkg-sot-torque-control       # Andrea dynamic graph entities

sudo apt-get install robotpkg-py27-eigenpy            # Python bindings
sudo apt-get install robotpkg-py27-pinocchio          # Python bindings
sudo apt-get install robotpkg-py27-parametric-curves  # Python bindings
sudo apt-get install robotpkg-py27-sot-core-v3        # Python bindings
sudo apt-get install robotpkg-py27-sot-torque-control # Python bindings
sudo apt-get install robotpkg-py27-sot-dynamic-pinocchio-v3 # Python bindings
sudo apt-get install robotpkg-py27-qt4-gepetto-viewer-corba # LAAS 3D robot viewer network client/server
